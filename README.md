...
Oracle, SQL Server, and DB2 require separate dialect modules with a valid license.

Visit [suprim.dev/pricing](https://suprim.dev/pricing) for commercial licenses.
